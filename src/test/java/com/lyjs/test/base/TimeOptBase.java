...
import com.lyjs.base.ThreadLocalUtil;
 ...
 * @date 2020/4/4
 */
public class TimeOptBase extends BaseTest {
    /*创建WebDriverWait的ThreadLocal和ThreadLocalUtil*/
    ...
    public WebDriverWait getWait(){
        return waitThreadLocalUtil.getThreadValue(threadWait);
    }
    /**
    ...
    public void setTimeouts(WebDriver webDriver){
        if(webDriver !=null){
            /*1.调用方法创建driver的WebDriverWaait对象*/
            setwait(webDriver);
            /*2.最大化窗口化*/
